...
export function NewsListing() {
  ...
  const filteredArticles = useMemo(() => {
    ...
    if (!selectedFilters.includes('All')) {
      results = results.filter(article => selectedFilters.includes(article.category));
    }
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/">
              <div className="flex items-center gap-4">
                ...
                />
                <h1 
                  className="font-bold tracking-tight hover:opacity-70 transition-all duration-700 ease-in-out" 
                  style={{ 
